...
try:
    ...
    df_t_pedido_detalle = spark_controller.read_table(data_paths.DOMINIO, "t_pedido_detalle", cod_pais=cod_pais)
    ...
    df_t_visita = spark_controller.read_table(data_paths.DOMINIO, "t_visita", cod_pais=cod_pais)
...
try:
    ...
    spark_controller.write_table(df_fact_kpi_detalle, data_paths.COMERCIAL, target_table_name, partition_columns_array)
except Exception as e:
    logger.error(e) 
    raise