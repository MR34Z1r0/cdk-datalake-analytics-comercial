...
try:
    ...
    m_tipo_embarque = spark_controller.read_table(data_paths.BIG_BAGIC, "m_tipo_embarque", cod_pais=cod_pais)
    m_termino = spark_controller.read_table(data_paths.BIG_BAGIC, "m_termino", cod_pais=cod_pais)
    m_proveedor = spark_controller.read_table(data_paths.BIG_BAGIC, "m_proveedor", cod_pais=cod_pais)
    m_unidad = spark_controller.read_table(data_paths.BIG_BAGIC, "m_unidad", cod_pais=cod_pais)
    t_cotizacion_compra = spark_controller.read_table(data_paths.BIG_BAGIC, "t_cotizacion_compra", cod_pais=cod_pais)
    t_orden_compra_cabecera = spark_controller.read_table(data_paths.BIG_BAGIC, "t_orden_compra_cabecera", cod_pais=cod_pais)
    t_orden_compra_detalle = spark_controller.read_table(data_paths.BIG_BAGIC, "t_orden_compra_detalle", cod_pais=cod_pais)
