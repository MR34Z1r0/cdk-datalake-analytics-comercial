...
try:
    ...
    m_departamento = spark_controller.read_table(data_paths.APDAYC, "m_ng1", cod_pais=cod_pais)
    m_persona = spark_controller.read_table(data_paths.APDAYC, "m_persona", cod_pais=cod_pais)
    m_persona_direccion = spark_controller.read_table(data_paths.APDAYC, "m_persona_direccion", cod_pais=cod_pais)
    m_provincia = spark_controller.read_table(data_paths.APDAYC, "m_ng2", cod_pais=cod_pais)
