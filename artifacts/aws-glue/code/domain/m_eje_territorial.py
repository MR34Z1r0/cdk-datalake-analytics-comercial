...
try: 
    ...
    df_m_distrito = spark_controller.read_table(data_paths.APDAYC, "m_ng3", cod_pais=cod_pais)
    df_m_provincia = spark_controller.read_table(data_paths.APDAYC, "m_ng2", cod_pais=cod_pais)
    df_m_departamento = spark_controller.read_table(data_paths.APDAYC, "m_ng1", cod_pais=cod_pais)
