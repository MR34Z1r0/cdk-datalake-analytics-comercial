...
try:
    ...
    df_centro_costo = spark_controller.read_table(data_paths.BIG_BAGIC, "m_centro_costo", cod_pais=cod_pais)
    df_centro_costo_corp = spark_controller.read_table(data_paths.BIG_BAGIC, "m_centro_costo_corporativo", cod_pais=cod_pais)
    df_area = spark_controller.read_table(data_paths.BIG_BAGIC, "m_area", cod_pais=cod_pais)
    df_gerencia = spark_controller.read_table(data_paths.BIG_BAGIC, "m_gerencia", cod_pais=cod_pais)
