...
try:
    ...
    m_documento_transaccion = spark_controller.read_table(data_paths.BIG_BAGIC, "m_documento_transaccion", cod_pais=cod_pais)
    t_orden_compra_ingreso = spark_controller.read_table(data_paths.BIG_BAGIC, "t_orden_compra_ingreso", cod_pais=cod_pais)
