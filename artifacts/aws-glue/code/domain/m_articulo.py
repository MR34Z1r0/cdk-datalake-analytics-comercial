...
try:
    ...
    #m_aroma =  spark_controller.read_table(data_paths.BIGMAGIC, "m_aroma")
    #m_gasificado =  spark_controller.read_table(data_paths.BIGMAGIC, "m_gasificado")
    #m_unidad_negocio =  spark_controller.read_table(data_paths.BIGMAGIC, "m_unidad_negocio")
