...
try:
    ...
    m_aroma =  spark_controller.read_table(data_paths.BIG_BAGIC, "m_aroma", cod_pais=cod_pais)
    m_gasificado =  spark_controller.read_table(data_paths.BIG_BAGIC, "m_gasificado", cod_pais=cod_pais)
    m_unidad_negocio =  spark_controller.read_table(data_paths.BIG_BAGIC, "m_unidad_negocio", cod_pais=cod_pais)
