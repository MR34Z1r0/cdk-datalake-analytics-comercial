...
try:
    ...
    m_linea =  spark_controller.read_table(data_paths.BIG_MAGIC, "m_linea", cod_pais=cod_pais)
    m_familia =  spark_controller.read_table(data_paths.BIG_MAGIC, "m_familia", cod_pais=cod_pais)
    m_subfamilia =  spark_controller.read_table(data_paths.BIG_MAGIC, "m_subfamilia", cod_pais=cod_pais)
    m_marca =  spark_controller.read_table(data_paths.BIG_MAGIC, "m_marca", cod_pais=cod_pais)
    m_presentacion =  spark_controller.read_table(data_paths.BIG_MAGIC, "m_presentacion", cod_pais=cod_pais)
    m_formato =  spark_controller.read_table(data_paths.BIG_MAGIC, "m_formato", cod_pais=cod_pais)
    m_sabor =  spark_controller.read_table(data_paths.BIG_MAGIC, "m_sabor", cod_pais=cod_pais)
    m_categoria =  spark_controller.read_table(data_paths.BIG_MAGIC, "m_categoria", cod_pais=cod_pais)
    m_tipo_envase =  spark_controller.read_table(data_paths.BIG_MAGIC, "m_tipo_envase", cod_pais=cod_pais)
    m_aroma =  spark_controller.read_table(data_paths.BIG_MAGIC, "m_aroma", cod_pais=cod_pais)
    m_gasificado =  spark_controller.read_table(data_paths.BIG_MAGIC, "m_gasificado", cod_pais=cod_pais)
    m_unidad_negocio =  spark_controller.read_table(data_paths.BIG_MAGIC, "m_unidad_negocio", cod_pais=cod_pais)
...
try:
    ...
    spark_controller.upsert(tmp_m_articulo, data_paths.DOMINIO, target_table_name, id_columns, partition_columns_array)
