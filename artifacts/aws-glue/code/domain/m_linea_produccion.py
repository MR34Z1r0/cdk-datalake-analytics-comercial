...
try:
    ...
    df_m_equipo_insumo = spark_controller.read_table(data_paths.APDAYC, "m_equipo_insumo", cod_pais=cod_pais)
...
try:
    ...
    spark_controller.upsert(tmp_dominio_m_linea_produccion, data_paths.DOMAIN, target_table_name, id_columns, partition_columns_array)
