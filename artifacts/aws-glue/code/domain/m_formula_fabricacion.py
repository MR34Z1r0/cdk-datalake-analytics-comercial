...
try:
    ...
    df_m_formula_fabricacion = spark_controller.read_table(data_paths.BIG_MAGIC, "m_formula_fabricacion", cod_pais=cod_pais) 
...
try:
    ...
    spark_controller.upsert(tmp_dominio_m_formula_fabricacion, data_paths.DOMINIO, target_table_name, id_columns, partition_columns_array) 
except Exception as e:
    logger.error(str(e))
    raise