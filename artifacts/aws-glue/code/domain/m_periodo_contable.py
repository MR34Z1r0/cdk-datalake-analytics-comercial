...
try:
    ...
    m_periodo = spark_controller.read_table(data_paths.APDAYC, "m_periodo", cod_pais=cod_pais)
    # m_fecha = spark_controller.read_table(data_paths.APDAYC, "m_fecha", cod_pais=cod_pais)
