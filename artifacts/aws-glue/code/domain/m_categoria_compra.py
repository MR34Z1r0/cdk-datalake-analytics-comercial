...
try:
    ...
    m_articulo_categoria_compra = spark_controller.read_table(data_paths.BIG_BAGIC, "m_articulo_categoria_compra", cod_pais=cod_pais)
    m_categoria_compra = spark_controller.read_table(data_paths.BIG_BAGIC, "m_categoria_compra", cod_pais=cod_pais)
    m_sub_categoria_compra = spark_controller.read_table(data_paths.BIG_BAGIC, "m_sub_categoria_compra", cod_pais=cod_pais)
    m_sub_categoria2_compra = spark_controller.read_table(data_paths.BIG_BAGIC, "m_sub_categoria2_compra", cod_pais=cod_pais)
