...
try:
    ...
    m_transportista = spark_controller.read_table(data_paths.BIG_MAGIC, "m_transportista", cod_pais=cod_pais)
    m_persona = spark_controller.read_table(data_paths.BIG_MAGIC, "m_persona", cod_pais=cod_pais)
    m_tipo_transportista = spark_controller.read_table(data_paths.BIG_MAGIC, "m_tipo_transportista", cod_pais=cod_pais)
