...
try:
    ...
    m_plan_cuentas = spark_controller.read_table(data_paths.BIG_BAGIC, "m_plan_cuentas", cod_pais=cod_pais)
    m_plan_cuentas.show()
    m_plan_cuentas_corporativo = spark_controller.read_table(data_paths.BIG_BAGIC, "m_plan_cuentas_corporativo", cod_pais=cod_pais)
    ...
    m_clasificacion_cuenta_contable_cogs = spark_controller.read_table(data_paths.BIG_BAGIC, "m_clasificacion_cuenta_contable_cogs", cod_pais=cod_pais)
    m_clasificacion_cogs = spark_controller.read_table(data_paths.BIG_BAGIC, "m_clasificacion_cogs", cod_pais=cod_pais)
