...
try: 
    ...
    df_m_vendedor = spark_controller.read_table(data_paths.APDAYC, "m_vendedor", cod_pais=cod_pais)
    df_m_persona = spark_controller.read_table(data_paths.APDAYC, "m_persona", cod_pais=cod_pais)
