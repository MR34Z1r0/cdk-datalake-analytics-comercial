...
try:
    ...
    df_t_historico_pedido_ades_cabecera = spark_controller.read_table(data_paths.BIG_MAGIC, "t_documento_pedido_ades", cod_pais=cod_pais)    
...
try:
    ...
    spark_controller.write_table(df_t_pedido, data_paths.DOMINIO, target_table_name, partition_columns_array)
except Exception as e:
    logger.error(e) 
    raise 